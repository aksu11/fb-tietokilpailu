<?php
	...
	if($_SESSION['kirjautunut'] != 'ok') header("Location: index.php");
 	...
 	$stmt = $db->query("SELECT * FROM kaikkien_aikojen_parhaat ORDER BY pisteet DESC, aika ASC");
	$i = 0;
...
<html id='osHtml'>
	<head><meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
		...
		<link href='tyyli.css' rel='stylesheet' type='text/css'><title>Kaikkien aikojen parhaat</title>
	</head>
	<body id='omasivu'>
		<div id="ilmoitus">Ei näin päin!<br>Toimii vain vaakatasossa</div>
		<table id='tilastotaulu'>
			<tbody>
				<tr><td colspan="12" id="osOtsikko">Kaikkien aikojen parhaat</td></tr>
